...
- `refund` (reverse all or part of a recorded payment, e.g. `payments:refund`)
- `export`
- `configure`
...
| Admin        | Office core, equipment configure, invoice view/create/edit/post/send, payment view/create/edit/refund, purchasing view/create/edit, inventory view/create/edit, jobCosting view/create/edit, estimate send, report view/export, employee permission view/configure, company settings view/configure, support logs/backups view/export, history view, and jobs configure. |
...
| Book Keeping | Office core, invoice view/create/edit/post/send, payment view/create/edit/refund, jobCosting view/create/edit, and report view/export.                                                                                                                                                                                                                                   |
