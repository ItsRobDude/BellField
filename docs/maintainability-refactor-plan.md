...
|   400 | `apps/office-web/src/modules/operations/job-detail-panel.tsx`         | Appointments, media, register entries, and display formatters split out (2026-09-06/07); the remaining tabs are thin wrappers, so this is close to done. |
