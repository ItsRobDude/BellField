...
| 9   |       Estimates/pricing/register/draft (8) |   5    |  2.5   |   4    | This is BellField's biggest parity miss. ServiceTitan Pricebook has services, categories, codes, descriptions, hours, dynamic/static/member/add-on pricing, material cost, income account, mobile view. BellField has register-to-draft and pricing logic, but no real selling catalog.                                               |
...
1. **Pricebook / flat-rate catalog** — by far the biggest market gap. ServiceTitan's
   pricebook is a sales system, not just a line-item list.
...
6. **Memberships / recurring service agreements** — ServiceTitan repeatedly exposes this in
   reports, pricebook/services, recurring service, and billing. BellField only has a register
   line kind today.
