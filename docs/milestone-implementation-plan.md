...
All Milestone 8 migrations (007–010) and the full posting/adjustment/payment/balance/bookkeeping runtime were verified locally against the default dev database. Later communication/payment-depth slices have since added invoice PDF/email delivery, full-balance online payment links, manual office refunds, and the provider-confirmed online refund backend path. Still later: online refund office UI/live smoke, partial payments, deposits, stored cards, and deeper processor-fee reconciliation.
