# BellField vs. Major FSM — Comparison Rubric (v2.1)
...
- Route optimization (incl. drag/drop-with-routing; plain dispatch drag/drop shipped 2026-06-07)
...
2026-07-14 — both same-day research passes (`BF-COMP-ST-2026-07-14-CLAUDE-01`,
`BF-COMP-ST-2026-07-14-CODEX-01`; see
[research-pass-log.md](./research-pass-log.md)) flagged that the out-of-scope
list had drifted behind shipped reality:

1. **Removed from out-of-scope (shipped):** customer estimate acceptance
   (Phase 6a acceptance links, live-smoked 2026-06-13); invoice PDF
   export/delivery and online payment capture (Phase 6b invoice email +
   Stripe Checkout payment links, live-smoked 2026-06-14/15).
2. **Clarified:** the route-optimization bullet now notes plain dispatch
   drag/drop shipped 2026-06-07; only routing-integrated behavior remains
   deferred.
3. Row 9's Excellent Standard no longer lists customer acceptance as a
   parity differentiator.
