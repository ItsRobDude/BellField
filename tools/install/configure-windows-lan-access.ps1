...
# Test-RuleProfileApplies, Test-PortFilterMatches, Test-RemoteAddressAllowsLocalSubnet,
# Get-ManagedRulePredicateReadback, Test-RuleReadbackEffective, and Test-ManagedRuleEffective
# are defined in lan-firewall-predicates.ps1 (dot-sourced above).
