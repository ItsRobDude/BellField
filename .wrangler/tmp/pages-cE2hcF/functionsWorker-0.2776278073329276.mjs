...
async function onRequestPost(context) {
  ...
  if (existing === null) {
    await context.env.WAITLIST.put(
      email,
      JSON.stringify({
        signedUpAt: /* @__PURE__ */ new Date().toISOString(),
...
// ../../.wrangler/tmp/pages-cE2hcF/functionsRoutes-0.04147311108622076.mjs
var routes = [
  {
...
// ../../.wrangler/tmp/bundle-nq74K8/middleware-insertion-facade.js
...
// ../../.wrangler/tmp/bundle-nq74K8/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2776278073329276.mjs.map
