...
// Job costing (Milestone 9): the non-inventory cost ledger (labor + expense events) plus
// the costing read model that rolls those up with inventory receiveToJob/issueToJob and the
